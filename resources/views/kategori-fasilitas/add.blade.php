          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Tambah Data Kategori Fasilitas</h4>
              </div>
              <div class="card-content collapse show">
                <div class="card-body">
                  <form method="post" action="{{ URL('kategori/fasilitas/store') }}">
                    {{ csrf_field() }}
                    <fieldset class="form-group">
                      <label>Kategori</label>
                      <input type="text" class="form-control" id="kategoriFasilitas" name="kategori_wisata"
                      required>
                    </fieldset>
                    <fieldset class="form-group">
                      <label>Status</label>

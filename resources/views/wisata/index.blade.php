    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">       
          <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="Wisata admin logo" src="theme-assets/images/logo/logo.png"/>
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="{{ route('customer') }}"><i class="ft-droplet"></i><span class="menu-title" data-i18n="">Customer</span></a>
          </li>
          <li class=" nav-item"><a href="{{ route('category') }}"><i class="ft-layers"></i><span class="menu-title" data-i18n="">Category</span></a>
          </li>
          <li class=" nav-item"><a href="{{ route('wisata') }}"><i class="ft-layout"></i><span class="menu-title" data-i18n="">Paket Wisata</span></a>
          </li>
          <li class=" nav-item"><a href="{{ route('pemesanan') }}"><i class="ft-credit-card"></i><span class="menu-title" data-i18n=""></span>Pemesanan</a>
          </li>
        </ul>
      </div>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Wisata</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Wisata
                  </li>
                </ol>
              </div>
            </div>

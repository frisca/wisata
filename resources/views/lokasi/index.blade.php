          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Daftar Data Lokasi</h4>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li>
                      <a href="{{ URL('lokasi/add') }}"><i class="ft-plus"></i></a>
                    </li>
                  </ul>
                </div>
              </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{ URL('lokasi/detail/' . $lokasi->id_lokasi) }}">
                              <button type="button" class="btn btn-icon btn-warning mr-1"><i class="ft-eye"></i></button>
                            </a>
                            <a href="{{ URL('lokasi/delete/' . $lokasi->id_lokasi) }}">

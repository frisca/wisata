                ...
                <div class="card-body">
                  <form method="post" action="{{ URL('syarat/change') }}">
                    ...
                    <fieldset class="form-group">
                      <label>Judul</label>
                      <input type="text" class="form-control" id="judul" name="judul" value="{{ $syarat->judul }}">
                    </fieldset>
                    <fieldset class="form-group">
                      <label>Deskripsi</label>
                      <textarea class="form-control" id="konten" rows="3" name="keterangan">{!! html_entity_decode($syarat->keterangan) !!}</textarea>
                    </fieldset>
                    <fieldset class="form-group">
                      <label>Wisata</label>

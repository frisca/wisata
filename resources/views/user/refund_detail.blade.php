    ...
    <div>
      ...
      @foreach($data as $p)
        ...
        <div class="col-md-6">
          ...
          <p>{{ date('d-m-Y', strtotime($p->tgl_refund)) }}</p>
        </div>

        <div class="col-md-6">
          <label>Total Sebelum</label>
          <p>IDR {{ number_format($p->total_sebelum, 0, '.', '.') }}</p>
        </div>

        <div class="col-md-6">
          <label>Total Refund</label>
          <p>IDR {{ number_format($p->total_refund, 0, '.', '.') }}</p>
        </div>
        ...
        <div class="col-md-6">
          <label>Waktu</label>
          <p>{{ strtoupper($p->waktu) }}</p>
        </div>

        <div class="col-md-6">
          <label>Dari Tanggal</label>
          <p>{{ date('d-m-Y', strtotime($p->dari_tgl_wisata)) }}</p>
        </div>

        <div class="col-md-6">
          <label>Sampai Tanggal</label>
          <p>{{ date('d-m-Y', strtotime($p->sampai_tgl_wisata)) }}</p>
        </div>
      @endforeach
    </div>
  </div>

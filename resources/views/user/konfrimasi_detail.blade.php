  ...
  <div class="container">
    ...
    <div>
      ...
      @foreach($data as $p)
        <div class="col-md-6">
          ...
          <p>{{ $p->nomor_pemesanan }}</p>
        </div>

        <div class="col-md-6">
          <label>Tanggal Pemesanan</label>
          <p>{{ date('d-m-Y', strtotime($p->tgl_pemesanan)) }}</p>
        </div>

        <div class="col-md-6">
          <label>Total</label>
          <p>IDR {{ number_format($p->total, 0, '.', '.') }}</p>
        </div>
        ...
        <div class="col-md-6">
          ...
          <p>IDR {{ number_format($p->jumlah_bayar, 0, '.', '.') }}</p>
        </div>
    ...
    <div>
      ...
      @foreach($pemesanandetail as $pd)
        ...
        <div class="col-md-6">
          <label>Waktu</label>
          <p>{{ strtoupper($pd->waktu) }}</p>
        </div>

        <div class="col-md-6">
          <label>Dari Tanggal</label>
          <p>{{ date('d-m-Y', strtotime($pd->dari_tgl_wisata)) }}</p>
        </div>

        <div class="col-md-6">
          <label>Sampai Tanggal</label>
          <p>{{ date('d-m-Y', strtotime($pd->sampai_tgl_wisata)) }}</p>
        </div>
      @endforeach
    </div>
  </div>
